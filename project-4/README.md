...
<details>
<summary><b>Q: Why not use <code>str[::-1]</code> for reversal?</b></summary>
...
- ✅ Knowledge of how numbers work at digit level

</details>

<details>
<summary><b>Q: What's the time complexity?</b></summary>

**A**: **O(log₁₀ n)** or equivalently **O(d)** where d is the number of digits.

**Explanation**: A number with n digits requires log₁₀(n) operations since we process each digit exactly once.

Example: 12391 has 5 digits → 5 iterations

</details>

<details>
<summary><b>Q: How does modulo 10 create wrap-around?</b></summary>

**A**: The expression `(digit + 1) % 10` creates a cyclic behavior:
...
<details>
<summary><b>Q: Why is string conversion acceptable for sum/increment?</b></summary>

**A**: The constraint specifically targets **reverse** without built-ins. For sum and increment:
...
- Real-world code often chooses readability over pure mathematics
